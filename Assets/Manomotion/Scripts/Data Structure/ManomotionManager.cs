...
public class ManomotionManager : ManomotionBase
{
    ...
    public void SetManoMotionSmoothingValue(float f)
    {
        manomotion_session.smoothing_controller = f;
    }
    ...
    /// </summary>
    /// <param name="slider">Slider.</param>
    public void SetManoMotionGestureSmoothingValue(float f)
    {
        manomotion_session.gesture_smoothing_controller = f;
    }
