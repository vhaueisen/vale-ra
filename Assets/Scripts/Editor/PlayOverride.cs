...
public class PlayOverride : EditorWindow
{
    [SerializeField]
    ...
    [SerializeField]
    static SceneAsset customMainScene;
    ...
    {
        EditorWindow.GetWindow(typeof(PlayOverride));
    }
    ...
    [MenuItem("Custom/SceneSelector/Play _%h")]
